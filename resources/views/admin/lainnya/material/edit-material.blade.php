<x-admin-layout>
    ...
    <div class="w-full text-sm">
        <div class="mb-5">
            ...
            <h2 class="text-gray-500">Silakan mengubah nomor dan deskripsi material dibawah ini</h2>
        </div>
        <div class="bg-white w-full rounded-lg p-5">
            <form action="/lainnya/material/edit" method="POST">
                @csrf
                <input type="hidden" name="id" value="{{ $material->id }}">
                <div class="mb-5">
                    <label for="material_number" class="text-sm font-semibold">Material Number</label>
                    <input type="text" name="material_number" id="material_number" value="{{ $material->material_number }}"
                ...
                <div class="mb-5">
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="w-full border border-gray-300 rounded-lg p-2 mt-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="Masukkan Deskripsi Material" required>{{ $material->description}}</textarea>
                </div>
                <button type="submit"
