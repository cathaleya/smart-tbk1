<x-admin-layout>
    ...
    <div class="w-full text-sm">
        <div class="mb-5">
            <h1 class="text-3xl font-bold">Tambah Type Kend (Tipe Kendaraan)</h1>
            <h2 class="text-gray-500">Silakan menambahkan nomor dan deskripsi su dibawah ini</h2>
        </div>
        <div class="bg-white w-full rounded-lg p-5">
            <form action="/lainnya/vehicle-type/tambah" method="POST">
                @csrf
                <div class="mb-5">
                    <label for="su" class="text-sm font-semibold">Inisial Tipe</label>
