                            ...
                            <tr class="bg-white">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex gap-2">
                                        ...
                                        <a href="/transport/{{ $transport->id }}/delete" onclick="return confirm('apakah anda yakin menghapus data ini?')" class="py-1 px-3 bg-red-500 text-white rounded-md">Delete</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
