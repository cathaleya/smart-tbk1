<aside class="w-[20%]   shadow-2xl font-bold text-gray-500 overflow-hidden">
    <aside class="fixed lg:w-[20%] w-[50%] h-full bg-white  overflow-hidden">
        ...
        <div class=" flex h-[50%] flex-col gap-2 px-5  my-5 overflow-y-scroll text-[10px] lg:text-[15px]">
            <a href="{{ route('dashboard') }}" class="{{ Request::is('dashboard*') ? 'bg-red-500 text-white ' : 'text-gray-500 hover:bg-gray-100'  }} flex py-3 px-5 justify-start pl-2 rounded-lg    ">
            ...
            <a href="{{ route('delivery-order') }}" class="{{ Request::is('delivery-order*') ? 'bg-red-500 text-white' : 'text-gray-500 hover:bg-gray-100'  }} flex py-3 px-5 justify-start pl-2 rounded-lg  ">
                <span class="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <a href="{{ route('warehouse') }}" class="{{ Request::is('warehouse*') ? 'bg-red-500 text-white' : 'text-gray-500 hover:bg-gray-100'  }} flex py-3 px-5 justify-start pl-2 rounded-lg  ">
                <span class="flex gap-2 items-center">
            ...
            <a href="{{ route('transport') }}" class="{{ Request::is('transport*') ? 'bg-red-500 text-white' : 'text-gray-500 hover:bg-gray-100'  }} flex py-3 px-5  justify-start pl-2 rounded-lg  ">
                <span class="flex gap-2 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <div class="w-full h-[40%] border-t-2 border-gray-200 p-5 flex flex-col gap-2">
            <div class="w-full flex py-2 ">
                ...
                <div class="flex flex-col justify-center ml-3">
                    <h1 class="text-[20px] pl-2">Recker</h1>
                    <span class="text-red-500 text-[10px] py-1 px-3 rounded-full border">Developer </span>
                </div>
            </div>
            <a href="" class="flex py-3 px-5 justify-start pl-2 rounded-lg hover:bg-gray-100  ">
                <span class="flex gap-2 items-center">
