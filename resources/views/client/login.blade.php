<x-pengunjung-layout>
    <div class="w-full h-screen flex justify-center items-center font-inter bg-gray-100 overflow-hidden">
            ...
            <div class="pl-5">
                ...
                <form action="{{ route('login') }}" method="POST" class="w-full">
                    ...
                    <table class="text-[12px]">
                        <tr>
                            <td class="p-2"><label for="email" class="capitalize">email</label></td>
                            <td class="p-2"><input type="email" name="email" value="{{ old('email') }}"
                        ...
                        <tr>
                            <td class="p-2"><label for="password" class="capitalize">password</label></td>
                            <td class="p-2"><input type="password" name="password"
                                    class="py-1 px-5 focus:outline-none border-2  rounded-xl focus:ring ring-red-500 focus:border-red-500"
                                    placeholder="*******"></td>
                        </tr>
                        <tr>
