<x-pengunjung-layout>
  <div class="w-full min-h-screen flex justify-center items-center font-inter ">
      <div class="bg-white p-10 flex lg:flex-row flex-col   rounded-lg lg:shadow-2xl lg:border lg:border-gray-100 ">
          ...
          <div class="pl-5">
              <div class="my-2">
                  <h1 class="text-center text-[30px] font-bold text-red-500">REGISTER</h1>
                  <p class="text-center text-gray-500 text-[12px]">Silahkan isi form dibawah ini untuk melakukan registrasi
                  </p>
              </div>
              <form action="">
                  <table class="text-[12px]">
                      <tr>
                          <td class="p-2"><label for="" class="capitalize">nama pengguna</label></td>
                      ...
                      <tr>
                          <td class="p-2"><label for="" class="capitalize">ketik ulang password</label></td>
                          <td class="p-2"><input type="text"
                                  class="py-1 px-5 focus:outline-none border-2  rounded-xl focus:ring ring-red-500 focus:border-red-500"
                                  placeholder="*******"></td>
                      </tr>
